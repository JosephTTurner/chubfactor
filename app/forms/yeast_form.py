...
class YeastForm(FlaskForm):
    ...
    def build(cls):
        ...
        cls.yeast_type_id = SelectField("Type:", choices=Yeast.choices(db_session))
...
class YeastCompareForm(FlaskForm):
    ...
    @classmethod
    def build(cls):
        cls.yeast_one = SelectField("Yeast One:", choices=Yeast.choices(db_session))
        cls.yeast_two = SelectField("Yeast Two:", choices=Yeast.choices(db_session))
